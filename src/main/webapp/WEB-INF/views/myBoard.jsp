...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <div class="w3-dropdown-hover w3-hide-small">
    <button class="w3-button w3-padding-large" title="Notifications" style="height:50px;"><i class="fa fa-bell"></i><span class="w3-badge w3-right w3-small w3-green"><%=plist.size() %></span></button>
